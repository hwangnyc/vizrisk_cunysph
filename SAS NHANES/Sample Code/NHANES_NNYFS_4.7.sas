...
/* Last updated 4/7/2014 by Henry Wang										*/
/* 																			*/
/****************************************************************************/
/*Create Libname*/
...
proc sgplot data=epi752.datafinal1;
  scatter x=BMXCALFF y=physicallyactive / group=RIAGENDR;
run;


PROC CORR data=epi752.datafinal1;
var BMXCALFF physicallyactive; run; 
